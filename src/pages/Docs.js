export default function Docs() {
    return (
        <div className="content text-left">
            <h1 className="text-[#A2A0D3] font-bold mt-5">RNAProDB Documentation</h1>

            <h2 className="text-[#A2A0D3] font-bold mt-5">Introduction</h2>
            <p className="mb-5 w-4/5 mx-auto text-left border-2 border-[#B22222] p-4 text-lg">
            ...
            <h3 className="text-[#A2A0D3] font-bold mt-5">1. RNA Search</h3>
            ...
            <h4 className="mt-5 text-[#A2A0D3] font-bold text-center">1.1. Sequence Viewer</h4>
            <p className="mb-5 w-4/5 mx-auto text-left border-2 border-[#B22222] p-4 text-lg">
            ...
            <h4 className="mt-5 text-[#A2A0D3] font-bold text-center">1.2. 3D Structure Viewer</h4>
            <p className="mb-5 w-4/5 mx-auto text-left border-2 border-[#B22222] p-4 text-lg">
            ...
            <h4 className="mt-5 text-[#A2A0D3] font-bold text-center">1.3. Interface Explorer</h4>
            <p className="mb-5 w-4/5 mx-auto text-left border-2 border-[#B22222] p-4 text-lg">
