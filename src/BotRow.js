...
function BotRow() {
  ...
  return (
    <div className="bot-row">
      ...
      <h1>DNAproDB is maintained by <a href="https://www.rohslab.org">The Rohs Lab</a> @ <a href="http://www.usc.edu">University of Southern California</a>. It is free to use by anyone, <b>including commercial users</b>.</h1>
    </div>
  );
}
