...
function SelectStoryUI({ subject }) {
    ...
    return _jsxs("select", { onChange: e => {
        ...
        }, children: [!current && _jsx("option", { value: '', children: "Select a story..." }), Stories.map(s => _jsxs("option", { value: s.id, selected: (current === null || current === void 0 ? void 0 : current.kind) === 'built-in' && current.id === s.id, children: ["Story: ", s.name] }, s.name)), (current === null || current === void 0 ? void 0 : current.kind) === 'url' && _jsx("option", { disabled: true, children: "------------------" }), (current === null || current === void 0 ? void 0 : current.kind) === 'url' && _jsx("option", { value: 'url', selected: true, children: current.url })] });
}
function init() {
